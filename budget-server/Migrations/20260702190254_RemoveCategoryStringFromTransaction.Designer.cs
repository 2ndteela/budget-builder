...
namespace budget_server.Migrations
{
    ...
    [Migration("20260702190254_RemoveCategoryStringFromTransaction")]
    partial class RemoveCategoryStringFromTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("budget_server.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("budget_server.Models.Category", "CategoryModel")
                        .WithMany("Transactions")
                        .HasForeignKey("CategoryId");
